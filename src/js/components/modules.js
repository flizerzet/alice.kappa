...
export function initSwitcher() {
	...
	if (!colorScheme) {
		localStorage.setItem('scheme', isDark ? '_dark' : '_light')
	}
	...
	function setTheme(theme) {
		document.documentElement.classList.remove('_light', '_dark');
		document.documentElement.classList.add(theme === '_dark' ? '_light' : '_dark')
		switcher.setAttribute('value', theme === '_dark' ? '_light' : '_dark')
